...
Un progetto può avere **+ obiettivi** ognuno prevedente dei **macro-prodotti** realizzati con **sotto-progetti**. In questi casi, il PBS può essere suddiviso in **fasi** in base agli **obiettivi realizzativi** (che **diventano fasi di 1° livello**); mentre **fasi prima principali** (tipo **progettazione**, **realizzazione**, **dispiegamento**…) diventano **sotto-attività di ogni obiettivo**. Esempio scuola:
