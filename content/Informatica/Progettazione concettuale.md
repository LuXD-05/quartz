...
Sono **oggetti della realtà raggruppati in una classe dato che hanno caratteristiche comuni** (elementi della realtà di cui è **necessario** il **salvataggio** di **dati**. Rappresentate con un **rettangolo**. Sempre **nomi singolari** + **iniziale maiuscola**.
