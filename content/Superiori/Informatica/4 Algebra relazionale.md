...
public: true
edited_seconds: 1080
modified_at: 20/04/2024 16:35:51
---
# Algebra relazionale
### Definizione
::
...
[[3 Progettazione logica#Grado|Grado di una relazione]], [[3 Progettazione logica#Cardinalità|Cardinalità di una relazione]]
...
Siano $R = (a_1,\; a_2, \;\ldots\; a_n)$ e $S = (b_1,\; b_2, \;\ldots\; b_n)$ due tuple. La loro concatenazione è: $R \;conc\; S = (a_{1}, a_{2}, \;\ldots\; a_{n}, b_{1}, b_{2}, \;\ldots\; b_{n})$.
Grado(R $*$ S) = Grado(R) + Grado(S)
Cardinalità(R $*$ S) = Cardinalità(R) $*$ Cardinalità(S)
Il risultato del prodotto cartesiano è: $R * S = { t \;|\; t = R \;conc\; S \;\ldots\; t \in R \;AND\; t \in S }$
