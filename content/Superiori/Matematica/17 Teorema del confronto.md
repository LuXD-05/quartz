Vedi: [[16 Integrali impropri#Convergenza e divergenza|Convergenza e divergenza]]

### 1° teorema del confronto

Siano $f$ e $g$ 2 funzioni continue in $\underset{a \;\leq\; x \;<\; b}{[a, b)}$, illimitate per $x \rightarrow b^{-}$ :
...
Siano $f$ e $g$ 2 funzioni continue in $\large x \;{\small\geq}\; a$:
...
Vedi poi: [[18 Equazioni differenziali]]
