...
public: true
edited_seconds: 4590
modified_at: 21/05/2024 16:52:46
---
### Integrale definito
Hint: processo (f(x), $a$ e $b$, rettangoli, $N$ e $\Delta x$, $S_{N}$ 1 e 2, Limite) + def (e quando esiste)
::
...
<!--SR:!2024-06-09,19,220-->

### Proprietà
Hint: 2 linearità indef, convenzioni (2), additività, monotonia, positività, int valore assoluto e int di f(x) costante
::
...
> (Libro 1298)
<!--SR:!2024-06-08,18,220-->

### 1° teorema fondamentale del calcolo integrale
Hint: (semplifica), formula (cont in interv), procedimento e esempio
::
...
<!--SR:!2024-06-07,17,220-->

### 2° teorema fondamentale del calcolo integrale
Hint: funzione integrale, teorema
::
###### Funzione integrale
