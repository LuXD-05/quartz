...
public: true
edited_seconds: 2560
modified_at: 21/05/2024 19:20:27
---
# Angoloidi
Hint: angoloide, (spigoli, triedro, vertice e facce)
::
> [!important] Angoloide
...
**Spigoli**: semirette che passano per il punto V e per i vertici del poligono (un angoloide con tre spigoli si chiama triedro).
**Facce**: angoli con vertice V e lati 2 spigoli consecutivi.
 
![](https://i.imgur.com/fqkJlpS.png)

### Piramidi
Hint: piramide, piramide retta, piramide regolare, piramide n-angolare (+ tetraedro) e apotema
::
> [!important] Piramide
...
---
Vedi poi: [[27 Solidi di rotazione]]