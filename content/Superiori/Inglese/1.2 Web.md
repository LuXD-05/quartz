...
public: true
edited_seconds: 580
modified_at: 21/06/2024 10:18:43
---
### HTML
Hint: def, consists of ?, tag pairs, (markup language)
::
...
- **Hw**: **physical devices** (packet switches or routers, but hosts/end-systems too, because they are access devices).
