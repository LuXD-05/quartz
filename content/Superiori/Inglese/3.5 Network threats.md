...
public: true
edited_seconds: 90
modified_at: 25/06/2024 00:05:08
---
### Network Threats
::
##### DoS
An **attacker send more requests to a pc than the ones it can handle**. Then, eventually, the <u>attackers connects on a service port to make forged packets enter the user's network</u> (more on [[3.6 DDoS]]).
##### Packet sniffing
