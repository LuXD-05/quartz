...
A **cookie** is an info that a website puts on a user's pc. They store limited info about a **browsing session** on a website that can be retrieved in the future. They can be accessed by the <u>browser</u>, a <u>website</u> o by a <u>3rd party</u>; and common use cases include: <u>session management</u>, <u>personalization</u> and <u>tracking</u>. They appeared for the 1st time on the Netscape browser to help it understand if a user had already visited a website.
...
- **1st-party cookies**: (a.k.a. <u>SameSite cookies</u>), them and the info they contain are <u>restricted to the same site</u> on which they were set.
