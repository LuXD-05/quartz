---
public: true
modified_at: 07/05/2024 16:17:42
edited_seconds: 2240
---
### Firma digitale
Hint: cos'è (+ autenticità), documento firmato (cosa ha)
::
##### Cos'è
...
#### CAdES
Hint: cos'è (estensione, visualizzazione), vantaggio e svantaggio, modi per apporre firme multiple (2), aggiunta dati dopo la firma (perché no? + anche se ... (esempio))
::
##### Cos'è
...
#### PAdES
Hint: cos'è (+ 2 vantaggi e svantaggio), predisposizione PDF (standard + 4 cose da fare), firme multiple (e versioning), aggiunta dati post-firma (perché)
::
##### Cos'è
