---
public: true
modified_at: 14/05/2024 23:44:13
edited_seconds: 2480
---
### Scomposizione del progetto

##### 1) Attività
Hint: individuazione, definizione
::
###### Individuazione
...
##### 3) Prodotti
Hint: intro, tipi (4), sottoprodotti + compiti + effort
::
...
##### 4) Prerequisiti
Hint: cosa sono (e input da altre attività), input incerti
::
...
##### 5) Tempi
Hint: durate progetto > attività > compiti > effort (+ ordine attività e tempo minimo realizzazione Gantt)
::
...
##### 7) Team
Hint: compiti > competenze > figure,   effort > risorse + tempo
::
...
### PBS
Hint: def (+ WBS), buona norma, codici (+ composizione), PBS per obiettivi realizzativi (intro, spiegazione, esempio)
::
