---
public: true
modified_at: 16/06/2024 16:21:14
edited_seconds: 460
---
### Caratteristiche
Hint: x cosa usato, connection oriented (3 + handshake), reliable (ritrasmissione e numerazione), flow control, congestion control, stateful, full duplex e unicast
::
...
### Connessione
Hint: 3-way handshake, terminazione della connessione e attacchi SYN flood
::
##### 3-way handshake
...
### Servizio affidabile
Hint: sequence number (cos'è, incremento (3), prevenzione di attacchi) e acknowledgement number (cos'è, incremento, perdite...)
##### Sequence number
