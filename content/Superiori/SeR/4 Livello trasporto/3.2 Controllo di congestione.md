---
public: true
modified_at: 16/06/2024 18:32:35
edited_seconds: 210
---
### Cos'è?
Hint: def, quando si ha congestione (inizio e aumento)
::
...
### Approfondimento
Hint: limite invio pacchetti (in base a congestione), cosa limita throughput (cwnd e rwnd), modalità invio pacchetti (slow start e congestion avoidance), perdite
::
TCP impone al mittente un **limite** alla <u>frequenza di invio dei segmenti</u> in base al <u>livello</u> “percepito” della <u>congestione</u>, grazie al **RTT** (usato dato che è a livello rete, di router e non trasporto). 
Il ***throughput*** (quantità di dati trasmessi nell’unità di tempo) di una comunicazione TCP è quindi limitato da:
