---
public: true
modified_at: 28/04/2024 00:29:06
---
### Protocolli di internet routing
Hint: intro, costo link, routing centralizzato e decentralizzato in generale
::
...
### AS
Hint: autonomous systems, intra e inter AS routing protocols
::
...
### RIP
Hint: distance-vector, cosa conosce (x dest), broadcast UDP e advertising (+ contenuti), router irraggiungibili
::
...
### OSPF
Hint: link-state, LSA, al contrario di RIP... (3), svantaggi (3)
::
...
### BGP
Hint: path-vector, cosa fa, distribuito, annunci sui percorsi (+ contenuti)
::
