---
public: true
modified_at: 15/06/2024 12:49:45
edited_seconds: 790
---
### Cos'è?
Hint: cos'è (RFC + client e server), caratteristiche (8)
::
...
##### Richieste
Hint: richieste, campi header (HURA ALEC KCKC)
::
...
##### Risposte
Hint: composizione, status codes, campi header (DSCC)
::
