...
Serve sempre un'etichetta per ogni gruppo di lettere da inserire con la lettera più piccola a sinistra.

Etichetta in 2-3 ha sempre e solo 2 lettere, mentre le foglie non ne hanno mai meno di 2 e mai più di 3.

Ad ogni insert, nelle label che hanno sotto delle foglie si prendono le lettere/numeri più piccole/i (come elementi della label), mentre per le label che hanno come figli altre label, si mettono le lettere finali maggiori dei primi 2 sottoalberi.

##### Regola i+1

Se al nodo padre abbiamo $i$ lettere, allora sotto avremo $i+1$ percorsi (solo per alberi 2-3-4)

###### MinMax

Cancellazione del minimo dei massimi:

![](https://i.imgur.com/jsqYjGJ.png)

Supponiamo di cancellare la G: con minmax, si traccia una riga sotto la G e ci chiediamo: "tra i massimi (valori a destra perché più grandi) quale è il minimo?" perché se lo si mette al posto della lettera da cancellare 

###### MaxMin

Cancellazione del massimo dei minimi:

???

Alberi binari --> elemento più a destra
