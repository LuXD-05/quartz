...
$A_{1} = \begin{bmatrix} {\color{lime}{1}} & {\color{gray}{2}} & {\color{gray}{0}} \\ {\color{gray}{0}} & {\color{gray}{1}} & {\color{gray}{2}} \\ {\color{gray}{1}} & {\color{gray}{3}} & {\color{gray}{2}} \end{bmatrix} \;\rightarrow\; det(A_{1}) = 1 \;\rightarrow\; rank(A) = 1$

$A_{2} = \begin{bmatrix} {\color{lime}{1}} & {\color{lime}{2}} & {\color{gray}{0}} \\ {\color{lime}{0}} & {\color{lime}{1}} & {\color{gray}{2}} \\ {\color{gray}{1}} & {\color{gray}{3}} & {\color{gray}{2}} \end{bmatrix} \;\rightarrow\; det(A_{2}) = 1 - 0 \neq 0 \;\rightarrow\; rank(A) = 2$

$A_{3} = \begin{bmatrix} {\color{lime}{1}} & {\color{lime}{2}} & {\color{lime}{0}} \\ {\color{lime}{0}} & {\color{lime}{1}} & {\color{lime}{2}} \\ {\color{lime}{1}} & {\color{lime}{3}} & {\color{lime}{2}} \end{bmatrix} \;\rightarrow\; det(A) = (sarrus) = 0 \;\rightarrow\; rank(A) = 2$
