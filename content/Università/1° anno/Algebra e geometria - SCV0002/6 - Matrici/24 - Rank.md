...
1) Si considera $x$ il minimo tra il n° di righe e di colonne della matrice in esame e si cerca una sottomatrice quadrata di quell'ordine al suo interno,
...
> [!important] Minore
> Data una matrice $A$ con $n$ righe e $m$ colonne, un suo **minore di ordine** $k$ è il <u>determinante di una sua sottomatrice quadrata</u> (sempre di ordine $k$) ottenuta <u>eliminando</u> $n - k$ <u>righe e</u> $m - k$ <u>colonne</u> (non necessariamente adiacenti).
...
> $$\begin{bmatrix} {\color{lightgreen}{1}} & {\color{lightgreen}{2}} & {\color{grey}{3}} \\ {\color{lightgreen}{4}} & {\color{lightgreen}{5}} & {\color{grey}{6}} \\ {\color{grey}{7}} & {\color{grey}{8}} & {\color{grey}{9}} \end{bmatrix}$$
> Come anche (eliminando la riga 1 e colonna 2):
> $$\begin{bmatrix} {\color{grey}{1}} & {\color{grey}{2}} & {\color{grey}{3}} \\ {\color{lightgreen}{4}} & {\color{grey}{5}} & {\color{lightgreen}{6}} \\ {\color{lightgreen}{7}} & {\color{grey}{8}} & {\color{lightgreen}{9}} \end{bmatrix}$$
...
> $$\begin{bmatrix} {\color{grey}{1}} & {\color{grey}{2}} & {\color{grey}{3}} & {\color{grey}{4}} \\ {\color{grey}{5}} & {\color{lightgreen}{6}} & {\color{lightgreen}{7}} & {\color{grey}{8}} \\ {\color{grey}{9}} & {\color{lightgreen}{10}} & {\color{lightgreen}{11}} & {\color{grey}{12}} \end{bmatrix}$$
> Orlando tale minore è possibile ottenere (per esempio) questa matrice (verde + blu):
> $$\begin{bmatrix} {\color{grey}{1}} & {\color{lightblue}{2}} & {\color{lightblue}{3}} & {\color{lightblue}{4}} \\ {\color{grey}{5}} & {\color{lightgreen}{6}} & {\color{lightgreen}{7}} & {\color{lightblue}{8}} \\ {\color{grey}{9}} & {\color{lightgreen}{10}} & {\color{lightgreen}{11}} & {\color{lightblue}{12}} \end{bmatrix}$$
