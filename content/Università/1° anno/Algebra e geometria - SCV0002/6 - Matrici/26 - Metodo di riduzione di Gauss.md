...
$$\begin{bmatrix} 
  ...
  1 & 0 & 4 & 2 \\ 
  \color{lightgreen}{0} & \color{lightgreen}{0} & \color{lightgreen}{0} & \color{lightgreen}{4} \\ 

  0 & 2 & 2 & 0 \\ 
  \color{lightgreen}{0} & \color{lightgreen}{1} & \color{lightgreen}{1} & \color{lightgreen}{0} 
...
Infine basta scambiare le ultime 2 righe per ottenere la matrice a scalini:

$$\begin{bmatrix} 

  1 & 0 & 4 & 2 \\ 
  0 & 1 & 1 & 0 \\ 
  \color{lightgreen}{0} & \color{lightgreen}{0} & \color{lightgreen}{0} & \color{lightgreen}{0} \\
