...
(Non so se vale anche per la divisione), il **prodotto** (righe $\times$ colonne) di 2 matrici $A_{n,m}$ e $B_{m,n}$ da come risultato una [[21 - Matrici#Matrice quadrata|matrice quadrata]] di **ordine** $n$.
