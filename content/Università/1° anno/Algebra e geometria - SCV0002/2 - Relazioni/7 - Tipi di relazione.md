...
Relazione sottoinsieme (definita su prodotto cartesiano di 2 $P(A)$):

$A = \{a,b,c\}$ e $R \subseteq P(A) \times P(A)$

$R = \{(x,y) \in P(A) \times P(A) \;|\; x \subseteq y\}$

Determina se è di equivalenza.

###### 2) Relazione di equivalenza

Relazione multipli di 4: $R_{4}= \{(x,y) \in \mathbb{Z} \times \mathbb{Z} \;|\; x - y \;\%\; 4 = 0\}$

Determina se è di equivalenza.

###### 3) Relazione di equivalenza

Data $R = \{(a,1),(b,2),(2,b)\} \in A \cup B$ (con $A = \{a,b\}$ e $B = \{1,2\}$), determina la più piccola relazione di equivalenza che contenga $R$ e determinane le classi di equivalenza.

# Soluzioni

###### 1) Relazione sottoinsieme
...
La più piccola relazione di equivalenza che contenga $R$ è:

$R_{e} = \{(a,a),(1,1),(b,b),(2,2),(a,1),(1,a),(b,2),(2,b)\}$

In quanto:

Riflessiva? Si, $\forall x \in R_{e} \rightarrow xRx$,

Simmetrica? Si, $\forall x,y \in R_{e} \rightarrow xRy \land yRx$,

Transitiva? Si, $\forall x,y,z \in R_{e} \rightarrow xRy \land yRz \implies xRz$.

Classi di equivalenza: $[a]_{R_{e}}, [b]_{R_{e}}$
