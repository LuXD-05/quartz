...
##### 4) Ricavare i segnali di controllo della CU

Occupiamoci ora della **CU** (*Control Unit*), nella quale:

**Input**: `op` e `funct` (per le operazioni *r-type*)

**Output**: segnali di controllo che guidano il datapath, tra cui:
