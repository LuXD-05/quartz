...
I registri (ma anche le cache) sono direttamente connessi all'ALU dato che ne salvano i risultati. Le altre memorie però devono comunicare con essi e per ciò si usano i **bus**.
