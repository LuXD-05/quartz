...
`.equals()` e `==` sono 2 modi per confrontare oggetti e variabili, ma differiscono in diversi aspetti:

##### Differenze

Supponiamo di avere 2 variabili così inizializzate:
...
Per confrontare oggetti è sempre meglio usare `.equals()`.
