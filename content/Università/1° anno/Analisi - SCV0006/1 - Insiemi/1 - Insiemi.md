...
Dato un insieme $A \subseteq \mathbb{R}, A \neq \emptyset$, un numero $n \in \mathbb{R}$ si dice:

- Maggiorante di $A$ se $\forall x \in A \implies n \geq x$ (numero che è maggiore di tutti i numeri in $A$),
- Minorante di $A$ se $\forall x \in A \implies n \leq x$ (numero che è maggiore di tutti i numeri in $A$).

Inoltre:

- $A$ è **superiormente limitato** se ammette almeno 1 maggiorante,
- $A$ è **inferiormente limitato** se ammette almeno 1 minorante.
...
(proposizione che esiste 1 solo max di A + dimostrazione per assurdo)

Dato un insieme $A \subseteq \mathbb{R}, A \neq \emptyset$, se $A$ è limitato (sia superiormente che inferiormente):

- Si dice **estremo superiore** ($sup(A)$) il più piccolo dei maggioranti di $A$,
- Si dice **estremo inferiore** ($inf(A)$) il più grande dei minoranti di $A$.
...
Teorema (completezza di $\mathbb{R}$):
