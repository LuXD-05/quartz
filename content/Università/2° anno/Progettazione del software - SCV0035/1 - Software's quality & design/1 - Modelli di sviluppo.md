...
> **MAI**, in quanto è una cattiva pratica in ogni caso.
...
> 1) Quando le richieste sono certe e inalterabili (non ammessi cambi a metà del processo),
> 2) Quando clienti e utenti non sono coinvolti nello sviluppo (commissionano il lavoro e ricevono quanto prodotto anche se le loro esigenze cambiano).
...
> - (Avendo sviluppatori responsabili e motivati).
