...
Oltre alle modalità manuali di *review* che abbiamo appena visto, è possibile fare delle **analisi statiche automatizzate** grazie a dei tool di analisi statica: strumenti che scansionano il codice per rilevare eventuali difetti senza eseguirlo; alcuni sono: compilatori, *bug pattern detectors*, *style checkers*, *design analyzers*, *data/control flow analyzers*...
...
Prossima lezione: [[6 - OOP in piccolo]]
