...
> È difficile riprodurre i *failures* (soprattutto in programmi concorrenti) in quanto gli errori sono difficili da trovare; perciò servono tool di monitoraggio adeguati.
...
Prossima lezione: [[4 - Software testing]]
