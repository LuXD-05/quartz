...
> L'integrità referenziale è il nome del vincolo delle FK e impone diverse regole:
...
> - Non si può eliminare una riga la cui PK è presente come FK in altre tabelle,
> - Non si può modificare la PK di una riga presente come FK in altre tabelle.
