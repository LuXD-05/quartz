...
Qui i comandi SQL sono utilizzati direttamente all'interno di un linguaggio di programmazione ospite ed un particolare pre-compilatore produce istantaneamente delle righe di codice equivalenti nel linguaggio ospite.
...
Prossima lezione: [[5 - Progettazione di database]]
