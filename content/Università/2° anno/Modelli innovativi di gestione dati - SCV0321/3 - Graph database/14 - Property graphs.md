...
Un *mapping* che soddisfa entrambi i precedenti [[#BGP matching|punti]], si dice **omomorfismo**; mentre un **isomorfismo** è il medesimo ma col vincolo di dover mappare variabili diverse di $Q$ su nodi/archi diversi di $G$. 

**SPARQL** si basa su omomorfismi, mentre i linguaggi basati su isomorfismi si distinguono in 3 **semantiche** diverse:
